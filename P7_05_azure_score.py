'''
Ce script sert à utiliser le modèle enregistré sur Azure.
Il inclu le prétraitement des données envoyées.
Le code pour envoyer des requêtes au modèle est contenu dans le notebook principal.
'''
